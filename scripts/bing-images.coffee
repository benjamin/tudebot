...
unless bingAccountKey
  console.log "You must set HUBOT_BING_ACCOUNT_KEY in your environment vairables"
...
imageMe = (msg, query, cb) ->
  msg.http('https://api.datamarket.azure.com/Bing/Search/Image')
    ...
    .query(Query: "'" + query + "'", Adult: "'Strict'", Market: "'en-AU'", $format: "json", $top: 50)
    .get() (err, res, body) ->
      try
        ...
        cb "failed to find images: #{query}"
